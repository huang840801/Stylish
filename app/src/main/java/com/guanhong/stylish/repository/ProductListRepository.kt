...
class ProductListRepository : IProductListRepository {
    override fun getProductList(params: String, paging: String?, productListCallback: DataResourceCallback.GetProductList) {
        val apiHelper = ApiHelper()
        apiHelper.getProductList(params, paging, productListCallback)
    }
}